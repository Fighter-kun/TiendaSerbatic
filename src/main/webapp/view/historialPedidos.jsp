...
<link rel="stylesheet" type="text/css"
	href="webroot/css/magnific-popup.css">
<link rel="stylesheet" type="text/css"
	href="webroot/css/owl.carousel.css">
...
<link rel="apple-touch-icon" sizes="72x72"
	href="webroot/images/apple-touch-icon-72x72.png">
<link rel="apple-touch-icon" sizes="114x114"
	href="webroot/images/apple-touch-icon-114x114.png">
</head>
			...
			<div class="row ">
				...
				<div class="col-sm-8 col-lg-9 mtb_20">
					<ul class="nav text-right">
						<li>
							<form id="ascendenteForm" action="HistorialPedidosServlet"
								method="post">
								<input type="radio" name="orden" value="ascendente"
									id="ascendente"> <label for="ascendente">Ascendente</label>
							</form>
						</li>
						<li>
							<form id="descendenteForm" action="HistorialPedidosServlet"
								method="post">
								<input type="radio" name="orden" value="descendente"
									id="descendente"> <label for="descendente">Descendente</label>
							</form>
						</li>
					</ul>
					<form>
							...
							<table class="table table-bordered">
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center"><%=pedido.getNumFactura() != null ? pedido.getNumFactura() : "PF"%></td>
									...
									%>
									<tr>
										<td class="text-center" colspan="5">No hay pedidos
											disponibles.</td>
									</tr>
									<%
									}
					...
					<div class="modal fade" id="pedidoDetalleModal" tabindex="-1"
						role="dialog" aria-labelledby="pedidoDetalleModalLabel"
						aria-hidden="true">
						<div class="modal-dialog modal-lg" role="document">
							<div class="modal-content">
								<div class="modal-header">
									<h5 class="modal-title" id="pedidoDetalleModalLabel">Líneas
										de Pedido</h5>
