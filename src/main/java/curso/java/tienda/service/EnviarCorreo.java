...
public class EnviarCorreo {
    private static final String DESTINATARIO = "carlos.daw2@gmail.com";
    ...
    public static boolean enviarCorreo(String nombre, String email, String numero, String mensajeTexto, String asunto) {
